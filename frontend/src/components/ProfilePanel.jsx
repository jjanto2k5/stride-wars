  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-[max(env(safe-area-inset-bottom),2rem)]">
          {isLoading ? (
            <div className="space-y-6 animate-pulse">
              <div className="flex flex-col items-center justify-center bg-gray-800/40 border border-gray-700/40 rounded-3xl p-6">
