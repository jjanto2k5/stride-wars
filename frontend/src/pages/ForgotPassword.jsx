    ...
    <div className="h-screen w-screen flex items-center justify-center bg-gray-900 px-6">
      <div className="w-full max-w-sm bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-700">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-3xl font-bold text-white tracking-wide">Forgot Password</h1>
          <p className="text-gray-400 text-sm mt-2 text-center">Enter your registered email to receive a password reset link.</p>
        </div>

        {message && <div className="bg-green-500/10 text-green-400 p-3 rounded-lg text-sm text-center mb-4 border border-green-500/20">{message}</div>}
